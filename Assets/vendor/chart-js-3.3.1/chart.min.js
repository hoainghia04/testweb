 ...
 */
    ...
    function De(t, e, i, n, o) {
        ...
        return Se(t, i, e, (function(i, l, c) {
            ...
            if (!Gt(h, t.chartArea, t._minPadding))
                return;
            const d = s(e, h);
            d < a ? (r = [{
                element: i,
    ...
    function li(t, i, n) {
        ...
        return r.observe(s),
        function(t, e) {
            si.size || window.addEventListener("resize", ri),
            si.set(t, e)
        }(t, a),
        r
    }
    ...
    class vi {
        ...
        _createAnimations(t, e) {
            ...
            for (r = s.length - 1; r >= 0; --r) {
                ...
                d && d.duration ? (o[l] = h = new _i(d,t,l,c),
                n.push(h)) : t[l] = c
            }
            return n
        }
    ...
    function Ti(t, e) {
        ...
        if (i) {
            ...
            for (const n of e) {
                const e = n._stacks;
                if (!e || void 0 === e[i] || void 0 === e[i][t.index])
                    return;
                delete e[i][t.index]
            }
        }
    ...
    class Ri {
        ...
        updateIndex(t) {
            this.index !== t && Ti(this._cachedMeta),
            this.index = t
        }
        linkScales() {
            const t = this
        ...
        updateRangeFromParsed(t, e, i, n) {
            ...
            s = ki(n, o, this._cachedMeta.index, {
                all: !0
            })),
            t.min = Math.min(t.min, s),
            t.max = Math.max(t.max, s)
    ...
    function Bi(t, e) {
        ...
        if (s > 0) {
            ...
            for (Wi(e, l, c, $(n) ? 0 : a - n, a),
            t = 0,
            i = s - 1; t < i; t++)
                Wi(e, l, c, o[t], o[t + 1]);
            return Wi(e, l, c, r, $(n) ? e.length : r + n),
            l
        }
        return Wi(e, l, c),
        l
    ...
    class Xi extends Ei {
        ...
        update(t, e, i) {
            ...
            o.display && (o.autoSkip || "auto" === o.source) && (n.ticks = Bi(n, n.ticks),
            n._labelSizes = null),
        ...
        fit() {
            ...
            if (a) {
                ...
                e.height = $i(s) + a) : (e.height = t.maxHeight,
                e.width = $i(s) + a),
    ...
    function on(t, e, i, n) {
        ...
        r.add(n);
        let l = sn(r, a, i, s || i);
        return null !== l && ((!ht(s) || s === i || (l = sn(r, a, s, l),
        null !== l)) && qi([...r], [""], o, s, (()=>function(t, e, i) {
    ...
    function un(t, e="x") {
        ...
        !function(t, e, i) {
            ...
            for (let h = 0; h < n - 1; ++h)
                l = c,
                c = cn(t, h + 1),
                l && c && (At(e[h], 0, ln) ? i[h] = i[h + 1] = 0 : (o = i[h] / e[h],
                s = i[h + 1] / e[h],
    ...
    function gn(t, e, i, n, o) {
        ...
        e.capBezierPoints && function(t, e) {
            ...
            n = t.length; i < n; ++i)
                ...
                r = i < n - 1 && Gt(t[i + 1], e),
                s && (o = t[i],
                a && (o.cp1x = fn(o.cp1x, e.left, e.right),
                o.cp1y = fn(o.cp1y, e.top, e.bottom)),
                r && (o.cp2x = fn(o.cp2x, e.left, e.right),
    ...
    function Zn(t) {
        return Gn() && "string" == typeof t ? t = document.getElementById(t) : t && t.length && (t = t[0]),
    ...
    class to {
        ...
        _resize(t, e) {
            ...
            ye(i, r, !0) && (i.notifyPlugins("resize", {
                size: a
            }),
            Q(n.onResize, [i, a], i),
        ...
        buildOrUpdateScales() {
            ...
            J(s, (i=>{
                const s = i.options
                  ...
                  , r = zn(a, s)
                  , l = K(s.type, i.dtype);
                void 0 !== s.position && Un(s.position, r) === Un(i.dposition) || (s.position = i.dposition),
                o[a] = !0;
                let c = null;
    ...
    class uo extends Ri {
        ...
        updateElements(t, e, i, n) {
            ...
            for (let l = e; l < e + i; l++) {
                ...
                h && (c.options = o.resolveDataElementOptions(l, n),
        ...
        update(t) {
            ...
            let {start: r, count: l} = function(t, e, i) {
                ...
                if (t._sorted) {
                    ...
                    d && (o = Nt(Math.min(oe(r, a.axis, c).lo, i ? n : oe(e, l, a.getPixelForValue(c)).lo), 0, n - 1)),
                    s = u ? Nt(Math.max(oe(r, a.axis, h).hi + 1, i ? 0 : oe(e, l, a.getPixelForValue(h)).hi + 1), o, n) - o : n - o
                }
                return {
                    start: o,
                    count: s
    ...
    function ko(t, e, i, n) {
        ...
        o.borderWidth && (s ? (t.lineWidth = 2 * o.borderWidth,
    ...
    function Vo(t) {
        ...
        const i = {};
        return e ? (e = t.horizontal ? Bo(e, "left", "right", t.base > t.x) : Bo(e, "bottom", "top", t.base < t.y),
        i[e] = !0,
        i) : i
    }
    function Bo(t, e, i, n) {
        var o, s, a;
        return n ? (a = i,
        t = Wo(t = (o = t) === (s = e) ? a : o === a ? s : o, i, e)) : t = Wo(t, e, i),
        t
    }
    function Wo(t, e, i) {
        ...
        beforeElementsUpdate: (t,e,i)=>{
            ...
            t.data.datasets.forEach(((e,o)=>{
                ...
                let h, {start: d, count: u} = function(t, e) {
                    ...
                    return l && (o = Nt(oe(e, s.axis, a).lo, 0, i - 1)),
                ...
                !function(t, e, i) {
                    ...
                    l.usePointStyle) {
                        ...
                        const o = e + Math.max((g - b) / 2, 0)
                          ...
                          , r = Ie(i.borderRadius);
                        a.beginPath(),
                        Object.values(r).some((t=>0 !== t)) ? ie(a, {
                            x: s,
                            y: o,
                            w: x,
                            h: b,
    ...
    class Is extends Xi {
        ...
        buildTicks() {
            ...
            const o = function(t, e) {
                ...
                w = p),
                m && x && o && Lt((a - s) / o, k / 1e3) ? (M = Math.min((a - s) / k, c),
                k = (a - s) / M,
                v = s,
                w = a) : b ? (v = m ? s : v,
                w = x ? a : w,
                ...
                v < s && P++,
                At(Math.round((v + P * k) * y) / y, s, Es(s, _, t)) && P++) : v < s && P++); P < M; ++P)
                    i.push({
    ...
    class Js extends Xi {
        ...
        _generate() {
            ...
            u++)
                Zs(h, d, g);
            return d !== n && "ticks" !== o.bounds && 1 !== u || Zs(h, d, g),
    ...
    return to.register(_o, ia, Uo, As),
    to.helpers = {
        ...On
    },
    to._adapters = so,
